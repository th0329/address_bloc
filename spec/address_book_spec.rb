...
RSpec.describe AddressBook do
  ...
  describe "#detonate" do
    it "should delete all entries" do
      ...
      book.detonate
      expect(book.detonate.size).to eq 0
    end
  end
  ...
  describe "#remove_entry" do
    it "removes an entry using the name, phone_number, and email address" do
      ...
      book.add_entry('Tony Hart', '212.212.2121', 'tony.hart@me.com')
      ...
      expect(book.entries.first.name).to eq('Tony Hart')
    end
  end
  ...
  describe "attributes" do
    ...
    describe "importing new entries from entries_2.csv" do
      it "imports the correct number of entries" do
